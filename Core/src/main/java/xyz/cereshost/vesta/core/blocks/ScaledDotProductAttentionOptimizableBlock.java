package xyz.cereshost.vesta.core.blocks;
...
public final class ScaledDotProductAttentionOptimizableBlock extends AbstractBlock {
    ...
    private ScaledDotProductAttentionOptimizableBlock(ScaledDotProductAttentionOptimizableBlock.Builder builder) {
        super(VERSION);
    ...
    protected NDList forwardInternal(
        ...
        NDArray normalizedAttentionScores = // Añadir a la cache
                attentionScores.mul(EngineUtils.floatToNDArray(1f / (float) Math.sqrt(H), inputs.getManager()));
            ...
            if (attentionMask.getShape().dimension() != 4) {
                ...
                maskOffset =
                        expandedMask
                                ...
                                .mul(EngineUtils.floatToNDArray(-1f, expandedMask.getManager()))// turn 1 into -1
                                .add(EngineUtils.floatToNDArray(1f, expandedMask.getManager())) // turn 0s to 1s, -1s to 0s
                                .mul(EngineUtils.floatToNDArray(-100000f, expandedMask.getManager())); // turn 1s (original 0s) into
     ...
     */
    public static ScaledDotProductAttentionOptimizableBlock.Builder builder() {
        return new ScaledDotProductAttentionOptimizableBlock.Builder();
    }

    /** A builder for {@link ScaledDotProductAttentionOptimizableBlock}s. */
    public static final class Builder {
         ...
         * @return this builder
         */
        public ScaledDotProductAttentionOptimizableBlock.Builder setEmbeddingSize(int embeddingSize) {
         ...
         * @return this builder
         */
        public ScaledDotProductAttentionOptimizableBlock.Builder setHeadCount(int headCount) {
         ...
         * @return this builder
         */
        public ScaledDotProductAttentionOptimizableBlock.Builder optAttentionProbsDropoutProb(float attentionProbsDropoutProb) {
         ...
         */
        public ScaledDotProductAttentionOptimizableBlock build() {
            if (embeddingSize < 1) {
            ...
            return new ScaledDotProductAttentionOptimizableBlock(this);
        }
    }
}
